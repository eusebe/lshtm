...
%\begin{textblock}{\textwidth}[0.5,0](6.5,2.8)\usebeamerfont{title}
%{\color{$if(titlecolor)$$titlecolor$$else$LSHTMLightgreen$endif$}\par\inserttitle}
%\end{textblock}
    \begin{tikzpicture}[overlay, remember picture]
        \node [xshift=0cm,yshift=0cm] at (current page.center) {
            % \includegraphics[width=\paperwidth, height=\paperheight]{$if(titlepage)$$titlepage$$else$titlepage$endif$}
            \includegraphics[width=\paperwidth, height=\paperheight]{$if(titlepage)$$titlepage$$else$titlepage$endif$}
        };
    \end{tikzpicture}

        \begin{tikzpicture}[overlay, remember picture] \node[align=flush center,text width=\textwidth,execute at begin node=\setlength{\baselineskip}{4ex}]  at (current page.center) {{\usebeamerfont{title}\color{$if(titlecolor)$$titlecolor$$else$LSHTMLightgreen$endif$}\inserttitle}\mbox{}\\[1cm]\color{$if(titlecolor)$$titlecolor$$else$LSHTMLightgreen$endif$}{\insertauthor}\mbox{}\\[0.2cm]
\insertdate};
        \end{tikzpicture}

% \begin{textblock}{10}[0.5,0](6.5,6)\centering
% {\color{$if(titlecolor)$$titlecolor$$else$LSHTMLightgreen$endif$}{\insertauthor}\mbox{}\\[0.2cm]
% \insertdate}
% \end{textblock}
}

% add logo to frametitle
%\addtobeamertemplate{headline}{}{%
%\begin{textblock*}{100mm}(.83\textwidth,0.15cm)
%\includegraphics[height=1cm,width=2cm]{logo}
%\end{textblock*}}
% new version which automatically fit with frametitle fontsize
\makeatletter
\setbeamertemplate{frametitle}{%
  ...
  \hfill
  \raisebox{-.25\height}{\includegraphics[height=3ex,keepaspectratio]{logo}}
  \end{beamercolorbox}%
}
\makeatother
